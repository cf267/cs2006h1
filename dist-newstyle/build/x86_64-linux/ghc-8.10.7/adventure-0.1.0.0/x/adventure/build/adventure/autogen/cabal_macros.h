...
/* package adventure-0.1.0.0 */
#ifndef VERSION_adventure
#define VERSION_adventure "0.1.0.0"
#endif /* VERSION_adventure */
#ifndef MIN_VERSION_adventure
#define MIN_VERSION_adventure(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_adventure */
...
#define CURRENT_COMPONENT_ID "adventure-0.1.0.0-inplace-adventure"
